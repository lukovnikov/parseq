...
def run(lr=0.0001,
    ...
    if ftmode == "ft":
        if originalinout:
            ...
            pt_type = "inoutonly"
    t5tok, t5, _ = load_t5(modelsize=modelsize, use_lm100k=not usedefaultmodel, pt_type=pt_type, pt_size=ptsize, adapterdim=adapterdim, out_vocab_size=out_vocab_size)
