...
def meta_train_epoch(model=None,
    ...
    while True:
        ...
        inneriter = infiter(data[chosendomain]["train"])
...
def run_experiments(domain="restaurants", gpu=-1, lr=0.0001, ftlr=0.0001, enclrmul=0.1, patience=5, cosinelr=False, fullsimplify=True, batsize=50, ftbatsize=20,
