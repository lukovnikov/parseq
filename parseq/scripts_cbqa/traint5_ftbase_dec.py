...
class Model(torch.nn.Module):
    ...
    def test_forward(self, x, y):
        ...
        predstring = [self.tok.decode(g, skip_special_tokens=True, clean_up_tokenization_spaces=True) for g in preds]
        targetstring = [self.tok.decode(t, skip_special_tokens=True, clean_up_tokenization_spaces=True)for t in y.unbind(0)]
